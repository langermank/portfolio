...
I've seen figma variants done with and without component nesting, and at this point made a button both ways. Having gone through the process a few times *sigh* I feel pretty confident in using controller components to build out variants. My key takeaway: **variants are like props and should be used to toggle states**. You don't want to be building core UI within the variant setup, you just want to hook it all up. Either way its a tedious process– but the end result is pretty rad.
